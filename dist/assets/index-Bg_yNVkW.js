...
function bo(e, n, t, r) {
  if (Dr) {
    var l = co(e, n, t, r);
    if (l === null) Ml(e, n, r, Ir, t), Yu(e, r);
    else if (tf(l, e, n, t, r)) r.stopPropagation();
    else if ((Yu(e, r), n & 4 && -1 < nf.indexOf(e))) {
      for (; l !== null; ) {
        var o = Jt(l);
        if (
          (o !== null && Ls(o),
...
var Tf = Qe && "TextEvent" in window && !Ct,
  Is = Qe && (!ru || (Ct && 8 < Ct && 11 >= Ct)),
  bu = " ",
  ei = !1;
function Fs(e, n) {
  switch (e) {
        ...
        for (var a = c, d; a !== null; ) {
          ...
          if (
            (d.tag === 5 &&
              v !== null &&
              ((d = v),
              f !== null && ((v = Ot(a, f)), v != null && S.push(Vt(a, v, d)))),
            F)
          )
            break;
          a = a.return;
...
function ai(e, n, t, r, l) {
  for (var o = n._reactName, u = []; t !== null && t !== r; ) {
    ...
    i.tag === 5 &&
      ...
      ((i = c),
      l
        ? ((s = Ot(t, o)), s != null && u.unshift(Vt(t, s, i)))
        : l || ((s = Ot(t, o)), s != null && u.push(Vt(t, s, i)))),
      (t = t.return);
  }
...
var yo = typeof setTimeout == "function" ? setTimeout : void 0,
  ...
  Gf =
    typeof queueMicrotask == "function"
      ...
      : typeof fi < "u"
        ? function (e) {
            return fi.resolve(null).then(e).catch(Zf);
          }
        : yo;
function Zf(e) {
  setTimeout(function () {
...
function $l(e) {
  ...
  if (((e = t.interleaved), e !== null)) {
    l = e;
    do (o = l.lane), (V.lanes |= o), (Ln |= o), (l = l.next);
    while (l !== e);
...
function wa(e, n, t) {
  return (
    (t = t != null ? t.concat([e]) : null), il(4, 4, ga.bind(null, n, e), t)
  );
}
function Su() {}
function Sa(e, n) {
...
function Ea(e, n, t) {
  return zn & 21
    ? (Me(t, n) || ((t = Ps()), (V.lanes |= t), (Ln |= t), (e.baseState = !0)),
      n)
  ...
  return (
    ...
    e !== null && !fe
      ? ((n.updateQueue = e.updateQueue),
        ...
        (e.lanes &= ~l),
        Xe(e, n, l))
      : (U && t && ou(n), (n.flags |= 1), ue(e, n, r, l), n.child)
  );
}
  ...
  return (
    ...
    e !== null && !fe
      ? ((n.updateQueue = e.updateQueue),
        ...
        (e.lanes &= ~l),
        Xe(e, n, l))
      : (U && r && ou(n), (n.flags |= 1), ue(e, n, t, l), n.child)
  );
}
function Li(e, n, t, r, l) {
  ...
  if ((Zn(n, l), n.stateNode === null))
    Nr(e, n), Pa(n, t, r), Co(n, t, r, l), (r = !0);
  else if (e === null) {
    var u = n.stateNode,
      i = n.memoizedProps;
    u.props = i;
...
function Ti(e, n, t, r, l) {
  return et(), iu(l), (n.flags |= 256), ue(e, n, t, r), n.child;
}
...
function cd(e, n, t, r, l, o, u) {
  ...
  if (((i = (u & e.childLanes) !== 0), fe || i)) {
    ...
    return Pu(), (r = Al(Error(y(421)))), mr(e, n, u, r);
  }
  return l.data === "$?"
    ? ((n.flags |= 128),
      (n.child = e.child),
...
function dd(e, n, t) {
  ...
  switch ((uu(n), n.tag)) {
        ...
        (e === null || e.child === null) &&
          (dr(n)
            ...
            : e === null ||
              ...
              ((n.flags |= 1024), Re !== null && (Uo(Re), (Re = null)))),
        To(e, n),
        re(n),
        null
      );
    ...
    case 4:
      return (
        tt(), To(e, n), e === null && $t(n.stateNode.containerInfo), re(n), null
      );
    case 10:
      return cu(n.type._context), re(n), null;
    case 17:
      return pe(n.type) && $r(), re(n), null;
    case 19:
...
function $a(e) {
  ...
  n !== null && ((e.alternate = null), $a(n)),
    ...
    e.tag === 5 &&
      ((n = e.stateNode),
      n !== null &&
        (delete n[Fe], delete n[At], delete n[go], delete n[Jf], delete n[qf])),
    (e.stateNode = null),
    (e.return = null),
    (e.dependencies = null),
...
function me(e, n) {
  ...
  if (r === 0)
    ...
    if ((t != null && Ku(t), n === 1))
      e.tag === 0 ? bf(Ui.bind(null, e)) : bs(Ui.bind(null, e)),
        Gf(function () {
          !(R & 6) && vn();
        }),
        (t = null);
...
function Wa(e, n) {
  ...
  if (r & 30 || r & e.expiredLanes || n) n = qr(e, r);
    ...
    R |= 2;
    var o = Ka();
    (J !== e || ee !== n) && ((Ve = null), (lt = Q() + 500), Cn(e, n));
    do
      try {
        Sd();
        break;
      ...
      switch (((e.finishedWork = l), (e.finishedLanes = r), n)) {
        ...
        case 3:
          if (
            ...
            e.timeoutHandle = yo(Sn.bind(null, e, ce, Ve), n);
            break;
          }
          Sn(e, ce, Ve);
          break;
        case 4:
          ...
          if (
            ...
            e.timeoutHandle = yo(Sn.bind(null, e, ce, Ve), r);
            break;
          }
          Sn(e, ce, Ve);
          break;
...
function Pu() {
  (X === 0 || X === 3 || X === 2) && (X = 4),
    J === null || (!(Ln & 268435455) && !(cl & 268435455)) || en(J, ee);
}
function qr(e, n) {
  var t = R;
  R |= 2;
...
function Ed(e, n, t) {
  ...
  r !== null && r.delete(n),
    ...
    J === e &&
      (ee & t) === t &&
      (X === 4 || (X === 3 && (ee & 130023424) === ee && 500 > Q() - Cu)
        ? Cn(e, 0)
        : (xu |= t)),
    me(e, n);
}
      ...
      return (
        ...
        l.$$typeof === void 0
          ? ((n.tag = 1),
            ...
            Co(n, r, e, t),
            (n = Po(null, n, r, !0, o, t)))
          : ((n.tag = 0), U && o && ou(n), ue(null, n, l, t), (n = n.child)),
        n
      );
    case 16:
      r = n.elementType;
...
gs = _u;
ws = Tn;
var Rd = { usingClientEntryPoint: !1, Events: [Jt, $n, ol, vs, ys, _u] },
  yt = {
...
const tc = b.createContext(void 0),
  Md = ({ children: e, contextOverride: n = void 0 }) => {
    const [t, r] = b.useState("");
    return j.jsx(tc.Provider, {
      value: { searchTerm: t, setSearchTerm: r, ...n },
      children: e,
    });
  },
  rc = () => {
  ...
  lc = () =>
    j.jsxs("div", {
      ...
      children: [
        ...
        j.jsx("span", { className: "sr-only", children: "Loading..." }),
      ],
    }),
  Dd = bi.memo(({ post: e, onDelete: n }) =>
    j.jsxs(
      "li",
      {
        className:
          "flex justify-between items-center bg-white p-4 border rounded shadow-md",
        children: [
          j.jsxs("div", {
            children: [
              j.jsx("h3", {
  ...
  Id = ({ posts: e, setPosts: n, loadMorePosts: t, loading: r }) => {
    const { searchTerm: l } = rc(),
      o = b.useRef(null),
      u = e.filter((c) => c.title.toLowerCase().includes(l.toLowerCase())),
      i = (c) => {
        n((h) => h.filter((m) => m.id !== c));
      },
      s = () => {
        if (o.current) {
          const { scrollTop: c, scrollHeight: h, clientHeight: m } = o.current;
          c + m >= h - 10 && !r && !l && t();
        }
      };
    return (
      ...
      j.jsxs("div", {
        ...
        children: [
          j.jsx("ul", {
            ...
            children: u.map((c) => j.jsx(Dd, { post: c, onDelete: i })),
          }),
          r &&
            j.jsx("div", {
              className: "fixed bottom-0 left-0 w-full pb-7 bg-transparent",
              children: j.jsx(lc, {}),
            }),
          !r &&
            u.length === 0 &&
  ...
  Ud = () => {
    const { searchTerm: e, setSearchTerm: n } = rc(),
      t = Fd(e, 300);
    return (
      b.useEffect(() => {
        n(t);
      ...
      j.jsx("div", {
        ...
        children: j.jsx("input", {
          ...
          className:
            "w-full max-w-md px-4 py-2 border rounded shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-400",
        }),
      })
    );
  },
    ...
    const [e, n] = b.useState([]),
      ...
      c = async (m) => {
        if (!t) {
          ...
          try {
            const p = await fetch(
              `https://jsonplaceholder.typicode.com/posts?_page=${m}`,
            );
            if (!p.ok) throw new Error("Failed to fetch posts");
            const g = await p.json();
            n((w) => [...w, ...g]), o(null);
          } catch (p) {
            console.error(p),
              o("Unable to load posts. Please try again later.");
          } finally {
            r(!1);
          }
        }
        ...
        children: [
          ...
          j.jsxs("div", {
            ...
            children: [
              l &&
                j.jsx("p", {
                  className: "text-center text-red-500 h-full",
                  children: l,
                }),
              t && e.length === 0
                ? j.jsx("div", {
...
Ql.createRoot(document.getElementById("root")).render(
  j.jsx(bi.StrictMode, { children: j.jsx($d, {}) }),
);
